...
CREATE MATERIALIZED VIEW sta."CE_FEATURES" AS 
 SELECT foi.codeoperationcep AS "ID",
    ...
    sta.ce_foi_prop(foi.mindateprel::text, foi.minheureprel::text, foi.maxdateprel::text, foi.maxheureprel::text, sta.codecourseau::text, sta.libellecourseau::text) AS "PROPERTIES"
